  ...
  const cards = [
    ...
    <div key="3" className="context-item">
      ...
      <p>
        ...
        We connect farms to refineries, ensuring compliance so both sides benefit from these subsidies.
      </p>
    </div>
  ]

  return (
    <section id="industry-context" className="section section-alt">
      <div className="container">
        <div className="section-header">
          <h2>The growing clean-fuel market</h2>
